...
def create_connection():
    return mysql.connector.connect(
        host='localhost',
        user='root',
        password='ramesh@05"',  # your MySQL password
        database='foods'
    )
...
def run_queries_and_save():
    ...
    writer = pd.ExcelWriter(f'daily_report_{now}.xlsx', engine='openpyxl')
    ...
    cursor.close()
    connection.close()
    print("✅ All 12 reports generated and saved to Excel successfully!")
